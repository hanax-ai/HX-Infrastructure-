...
def mock_successful_delete(monkeypatch):
    ...
    async def fake_delete_by_namespace(namespace):
    ...
    monkeypatch.setattr(delete_route, "delete_by_ids", fake_delete_by_ids)
    monkeypatch.setattr(delete_route, "delete_by_namespace", fake_delete_by_namespace)
    monkeypatch.setattr(delete_route, "delete_by_filter", fake_delete_by_filter)
...
def mock_qdrant_error(monkeypatch):
    ...
    monkeypatch.setattr(delete_route, "delete_by_ids", failing_delete)
    monkeypatch.setattr(delete_route, "delete_by_namespace", failing_delete)
    monkeypatch.setattr(delete_route, "delete_by_filter", failing_delete)
...
class TestDeleteByIds:
    ...
    def test_delete_by_ids_invalid_request(self, client):
        ...
        # Invalid ids type
        response = client.post("/v1/rag/delete/by_ids", json={"ids": "not-a-list"}, headers=headers)
        assert response.status_code == 422
...
class TestDeleteByNamespace:
    ...
    def test_delete_by_namespace_success(self, client, mock_successful_delete):
        ...
        response = client.post("/v1/rag/delete/by_namespace", json=payload, headers=headers)
...
class TestDeleteByFilter:
    ...
    def test_delete_by_filter_success(self, client, mock_successful_delete):
        ...
        response = client.post("/v1/rag/delete/by_filter", json=payload, headers=headers)
...
class TestDeleteIntegration:
    ...
    def test_full_delete_workflow(self, client, mock_successful_delete):
        ...
        response = client.post("/v1/rag/delete/by_ids", 
                             json={"ids": ["doc1", "doc2"]}, 
                             headers=headers)
        assert response.status_code == 200
        ...
        response = client.post("/v1/rag/delete/by_namespace", 
                             json={"namespace": "docs:test"}, 
                             headers=headers)
        assert response.status_code == 200
        
        # 3. Clean up with filter-based deletion
        response = client.post("/v1/rag/delete/by_filter", 
